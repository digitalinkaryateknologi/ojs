...
',
  ...
  'plugins.generic.orcidProfile.manager.status.configuration.clientIdInvalid' => 'Client Id is invalid valid, please check your input',
  'plugins.generic.orcidProfile.manager.status.configuration.clientSecretValid' => 'Client Secret is valid',
  'plugins.generic.orcidProfile.manager.status.configuration.clientSecretInvalid' => 'Client Secret is invalid valid, please check your credentials',
